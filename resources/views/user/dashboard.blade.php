...
@section('title', 'لوحة التحكم - ' . auth()->user()->name)
                            ...
                            <div class="flex items-center space-x-4 space-x-reverse">
                                ...
                                @else
                                    <div class="w-16 h-16 bg-gray-200 rounded-lg flex items-center justify-center">
                                        <i class="fas fa-satellite-dish text-gray-500 text-xl"></i>
                                    </div>
                                @endif
                                <div class="flex-1">
                                    <h4 class="font-medium">{{ $order->product->name ?? 'المنتج غير متاح' }}</h4>
                                    <p class="text-sm text-secondary-600">الكمية: {{ $order->quantity }}</p>
                                    @if($order->delivery_address)
                                        <p class="text-sm text-secondary-600">العنوان: {{ $order->delivery_address }}</p>
                                    @endif
                                </div>
                                <div class="text-left">
                        ...
                        <div class="flex items-center space-x-4 space-x-reverse">
                            ...
                            @else
                                <div class="w-20 h-20 bg-gray-200 rounded-lg flex items-center justify-center">
                                    <i class="fas fa-satellite-dish text-gray-500 text-2xl"></i>
                                </div>
                            @endif
                            <div class="flex-1">
